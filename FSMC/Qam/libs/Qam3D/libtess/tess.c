...
/*ARGSUSED*/ static void noBegin( GLenum type ) { UNUSED(type) ; }
/*ARGSUSED*/ static void noEdgeFlag( GLboolean boundaryEdge ) { UNUSED(boundaryEdge) ; }
/*ARGSUSED*/ static void noVertex( void* data ) { UNUSED(data) ; }
/*ARGSUSED*/ static void noEnd( void ) {}
/*ARGSUSED*/ static void noError( GLenum errnum ) { UNUSED(errnum) ; }
/*ARGSUSED*/ static void noCombine( GLdouble coords[3], void* data[4],
									GLfloat weight[4], void** dataOut ) { UNUSED(coords) ; UNUSED(data) ; UNUSED(weight) ; UNUSED(dataOut) ; }
/*ARGSUSED*/ static void noMesh( GLUmesh* mesh ) { UNUSED(mesh) ; }
...
/*ARGSUSED*/ void __gl_noBeginData( GLenum type,
						 void* polygonData ) { UNUSED(type) ; UNUSED(polygonData) ; }
/*ARGSUSED*/ void __gl_noEdgeFlagData( GLboolean boundaryEdge,
					   void* polygonData ) { UNUSED(boundaryEdge) ; UNUSED(polygonData) ; }
/*ARGSUSED*/ void __gl_noVertexData( void* data,
						  void* polygonData ) { UNUSED(data) ; UNUSED(polygonData) ; }
/*ARGSUSED*/ void __gl_noEndData( void* polygonData ) { UNUSED(polygonData) ; }
/*ARGSUSED*/ void __gl_noErrorData( GLenum errnum,
						 void* polygonData ) { UNUSED(errnum) ; UNUSED(polygonData) ; }
/*ARGSUSED*/ void __gl_noCombineData( GLdouble coords[3],
						   void* data[4],
						   GLfloat weight[4],
						   void** outData,
						   void* polygonData ) { UNUSED(coords) ; UNUSED(data) ; UNUSED(weight) ; UNUSED(outData) ; UNUSED(polygonData) ; }
...
//void GLAPI gluGetTessProperty( GLUtesselator *tess, GLenum which, GLdouble *value )
...
//    tess->callEdgeFlag = (fn == NULL) ? &noEdgeFlag : (void (GLAPI *)(GLboolean)) fn;
...
//    tess->callVertex = (fn == NULL) ? &noVertex : (void (GLAPI *)(void *)) fn;
...
//    tess->callEndData = (fn == NULL) ? &__gl_noEndData : (void (GLAPI *)(void *)) fn;
...
//    tess->callErrorData = (fn == NULL) ? &__gl_noErrorData : (void (GLAPI *)(GLenum, void *)) fn;
	tess->callErrorData = (fn == NULL) ? &__gl_noErrorData : (void (*)(GLenum, void *)) fn;
	return;
  case GLU_TESS_COMBINE:
//    tess->callCombine = (fn == NULL) ? &noCombine : (void (GLAPI *)(GLdouble [3],void *[4], GLfloat [4], void ** )) fn;
	tess->callCombine = (fn == NULL) ? &noCombine : (void (*)(GLdouble [3],void *[4], GLfloat [4], void ** )) fn;
	return;
...
//void GLAPI gluBeginPolygon( GLUtesselator *tess )
...
/*ARGSUSED*/
//void GLAPI gluNextContour( GLUtesselator *tess, GLenum type )
...
//void GLAPI gluEndPolygon( GLUtesselator *tess )
