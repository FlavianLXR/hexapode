...
#include <qiodevice.h>
#include <QTimer>
#include "trdatagram.h"
#include "ui_trdatagram.h"
...
{
    ui->statconnection->setText("<font color='red'>DECONNECTER</font>");
}
...
void UDP::traitementDatagram()
{
    ...
    timer->start(100);
    ui->statconnection->setText("<font color='lime'>CONNECTER</font>");
